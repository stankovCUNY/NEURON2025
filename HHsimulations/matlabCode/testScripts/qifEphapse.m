function qifEphapse(timeMin,inputType)
...
%     close all
    ...
    frozenNoiseTar = 100*normrnd(0,1,1,length(t));
...
%     waveIdx = r + LL;
    ...
    % Parameters of the Quadratic Integrate and Fire model
    tau = 10; % Membrane time constant (ms)
    V_rest = -65; % Resting potential (mV)
    V_threshold = 30; % Spiking threshold (mV)
    ...
    for i = 1:length(t)
        ...
        % Update variable using QIF model equation
        dv = (v^2 + Input + frozenNoiseTar(i)) / tau;
