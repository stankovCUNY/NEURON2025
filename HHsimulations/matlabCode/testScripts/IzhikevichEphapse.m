function IzhikevichEphapse(timeMin,inputType)
...
%     close all
    ...
    frozenNoiseTar = 10*normrnd(0,1,1,length(t));
    ...
    I_current_tar(30/dt:end) = 5; % Input of 3 microA/cm2 beginning at 50 ms and steady until end of time period.
...
%     waveIdx = r + LL;
    ...
    % Initial conditions
    v = Vrest; % Initial membrane potential
    ...
    for i = 1:length(t)
        ...
        % Calculating the input
        Input = juncSwitch(i)*I_current_tar(i);
        
        % Update variables using Izhikevich model equations
        dv = 0.04 * v^2 + 5 * v + 140 - u + Input + frozenNoiseTar(i);
        du = a * (b * v - u);
