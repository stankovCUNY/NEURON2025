function HodgkinHuxleyGJohmic(timeMin)
...
%         Input_tar = I_current(i) - (I_Na_tar(i) + I_K_tar(i) + I_Leak_tar(i)) + gC*(Vref(i)-Vtar(i));
        Input_tar = I_current_tar(i) - (I_Na_tar(i) + I_K_tar(i) + I_Leak_tar(i)) + juncSwitch(i)*g_GJtar*(Vref(i)-Vtar(i));
