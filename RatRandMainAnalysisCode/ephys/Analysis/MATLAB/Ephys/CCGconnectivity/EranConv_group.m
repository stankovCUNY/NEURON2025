...
for cell_i=1:nCells-1
    ...
    for cell_j=cell_i+1:nCells % parfor
...
%             if (ismember(peak_ii, MonoWindow3) && peak<alpha)
            % ATANAS STANKOV EDIT DEC 19, 2021
            if (ismember(peak_ii, MonoWindow3) && peak<alpha) || ((ismember(trough_ii, MonoWindow3) && trough<(alpha)))
